    ...
    var Upload = Backbone.View.extend({
      ...
      upload: function (_file) { //get dataUrl
        ...
        reader.onload = function (readerEvent) {
          ...
          image.onload = function (imageEvent) {
            ...
            if(_scale<=1) {  //no need
              self.rotate_flip_image(null, _dataUrl, backendUploadMaxWH, orientation, self.img_is_FlippedRotated);
            }else{      //upload
              ...
              self.rotate_flip_image(resizedPhotoUrl, null, backendUploadMaxWH, orientation, self.img_is_FlippedRotated);
            }
          }
        }
      },
      ...
      upload_image_to_touchCanvas: function (_url, _dataUrl, _img_with_crossdomain_issue) {
        ...
        function step1_preUpload(_url, _dataUrl, _img_with_crossdomain_issue){
          ...
          if(curLang !="cn") fbTrackGMApp('upload-photo');
          OC_ET.event("edbgu");
      ...
      */
      ...
      rotate_flip_image: function (_url, _dataUrl, _maxSize, _orientation, _callback) {
        ...
        newImg.onload = function (imageEvent) {
          ...
          /*var preCanvas = document.getElementById("preUploadFaceCanvas");
          preCanvas.width=canvas.width;
          preCanvas.height=canvas.height;
          var preCtx = preCanvas.getContext("2d");
          preCtx.drawImage(canvas, 0, 0, canvas.width, canvas.height);*/
      },
